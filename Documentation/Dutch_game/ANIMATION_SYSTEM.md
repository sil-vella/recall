# Animation System Documentation - Dutch Game

## Overview

This document describes the card animation system for the Dutch game. The system automatically detects card movements and animates them smoothly across the game board, including draw, play, collect, reposition, and jack swap animations.
...
The animation system provides smooth, automatic card animations for all card movements in the Dutch game. It uses a three-component architecture:
