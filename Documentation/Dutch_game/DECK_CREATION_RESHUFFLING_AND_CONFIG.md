# Deck Creation and Configuration Documentation - Dutch Game

## Overview

This document describes the deck creation and configuration system for the Dutch game. It covers YAML configuration files, deck factory implementation, platform-specific file loading, and how decks are created and used during gameplay.
...
### Documentation
- `Documentation/Dutch_game/STATE_MANAGEMENT.md` - State management documentation
- `Documentation/Dutch_game/PLAYER_ACTIONS_FLOW.md` - Player actions documentation
