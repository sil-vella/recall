...
class FlutterAppConfigurator:
    ...
    def update_main_dart(self):
        ...
        try:
            ...
            content = re.sub(
                rf'title:\s*"({re.escape(self.old_package_name)}|dutch|Flutter Base 04)\s*App"',
    ...
    def update_config_dart(self):
        ...
        try:
            ...
            # Replace app title - more flexible pattern
            content = re.sub(
                rf'static const String appTitle = "({re.escape(self.old_package_name)}|Dutch|dutch)";',
    ...
    def update_android_manifest(self):
        ...
        try:
            ...
            content = re.sub(
                rf'android:label="({re.escape(self.old_package_name)}|dutch|Flutter Base 04)"',
            ...
            content = re.sub(
                rf'android:scheme="({re.escape(self.old_package_name)}|dutch)"',
    ...
    def update_connections_api_module(self):
        ...
        try:
            ...
            content = re.sub(
                rf"'app': '({re.escape(self.old_package_name)}|dutch)://\$path'",
    ...
    def update_package_imports(self):
        ...
        old_package_names.extend(['dutch', 'flutter_base_04'])
        # Remove duplicates
