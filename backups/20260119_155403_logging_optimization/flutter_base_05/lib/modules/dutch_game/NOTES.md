...
### Issue
Ensure that ANY state change in the Dutch game is immediately detected and sent to the card position tracker and animation callbacks.
...
### Related Files
- `lib/modules/dutch_game/managers/card_animation_manager.dart`
- `lib/modules/dutch_game/utils/card_position_tracker.dart`
- `lib/modules/dutch_game/screens/game_play/widgets/card_animation_layer.dart`
