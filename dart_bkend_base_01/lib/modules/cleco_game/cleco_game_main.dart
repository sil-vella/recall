...
class ClecoGameModule {
  ...
  ClecoGameModule(this.server, this.roomManager, this.hooksManager) {
    coordinator = GameEventCoordinator(roomManager, server);
    _registerHooks();
    _logger.info('ClecoGameModule initialized with hooks', isOn: LOGGING_SWITCH);
  }
  ...
  void _registerHooks() {
    ...
    _logger.info('🎣 ClecoGame: Registered hooks for game lifecycle', isOn: LOGGING_SWITCH);
  }
