...
class ComputerPlayerConfig {
  ...
  static Future<ComputerPlayerConfig> fromFile(String filePath) async {
    try {
      ...
      if (filePath.startsWith('assets/')) {
        ...
        final candidate = File('lib/modules/cleco_game/config/computer_player_config.yaml');
  ...
  /// Get cleco strategy for a difficulty level
  Map<String, dynamic> getClecoStrategy(String difficulty) {
    final config = getDifficultyConfig(difficulty);
    return config['cleco_strategy'] ?? {};
  }
