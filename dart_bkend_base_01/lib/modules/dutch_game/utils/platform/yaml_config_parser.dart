  ...
  static Future<DeckConfig> fromFile(String filePath) async {
    try {
      ...
      if (filePath.startsWith('assets/')) {
        ...
        final backendCoreCandidate = File('lib/modules/dutch_game/backend_core/config/deck_config.yaml');
        final regularCandidate = File('lib/modules/dutch_game/config/deck_config.yaml');
      ...
      throw Exception('Failed to load deck config from $filePath: $e');
    }
  }
