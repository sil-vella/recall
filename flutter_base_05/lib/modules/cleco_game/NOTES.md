...
### Issue
Ensure that ANY state change in the Cleco game is immediately detected and sent to the card position tracker and animation callbacks.
...
### Related Files
- `lib/modules/cleco_game/managers/card_animation_manager.dart`
- `lib/modules/cleco_game/utils/card_position_tracker.dart`
- `lib/modules/cleco_game/screens/game_play/widgets/card_animation_layer.dart`
