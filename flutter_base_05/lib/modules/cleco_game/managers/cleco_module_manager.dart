/// # Cleco Module Manager
/// 
/// The central orchestrator for all Cleco card game functionality. This manager serves as the
...
/// 
/// ### Integration Points
/// - **StateManager**: Uses existing `cleco_game` state registration from main module
...
/// - **Game Helpers**: Utilizes ClecoGameHelpers for game logic operations
/// 
...
/// └── Game Logic (via ClecoGameHelpers)
/// ```
/// 
/// ## Usage:
/// 
/// ```dart
/// final gameManager = ClecoModuleManager();
/// 
...
/// Cleco Module Manager
/// Main orchestrator for the Cleco game functionality
class ClecoModuleManager {
  static final ClecoModuleManager _instance = ClecoModuleManager._internal();
  
  factory ClecoModuleManager() => _instance;
  ClecoModuleManager._internal();
  ...
  /// Initialize the Cleco Module manager
  Future<bool> initialize() async {
    ...
    try {
      ...
      // Register cleco-specific Socket.IO events in one place and fan out via WSEventManager
      try {
      ...
      // State registration is now handled by cleco_game_main.dart
