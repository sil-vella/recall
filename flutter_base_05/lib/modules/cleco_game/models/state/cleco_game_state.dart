...
/// Main immutable state for the entire Cleco Game module
/// This is the Single Source of Truth (SSOT) for all cleco game state
@immutable
class ClecoGameState extends ImmutableState with EquatableMixin {
  // Connection state
  ...
  factory ClecoGameState.initial() {
    return ClecoGameState(
      isLoading: false,
      isConnected: false,
      currentRoomId: '',
      isInRoom: false,
  ...
  factory ClecoGameState.fromJson(Map<String, dynamic> json) {
  ...
  @override
  String toString() => 'ClecoGameState(game=$currentGameId, ${games.games.length} games)';
}
