...
class GameStateData extends ImmutableState with EquatableMixin {
  ...
  GameStateData copyWith({
    ...
    return GameStateData(
      ...
      clecoCalledBy: clecoCalledBy ?? this.clecoCalledBy,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'phase': phase,
      if (clecoCalledBy != null) 'clecoCalledBy': clecoCalledBy,
  ...
  factory GameStateData.fromJson(Map<String, dynamic> json) {
    ...
    return GameStateData(
      ...
      clecoCalledBy: json['clecoCalledBy'] as String?,
  ...
  List<Object?> get props => [
    ...
    clecoCalledBy, lastPlayedCard, winners
  ];
