...
/// 
/// This widget subscribes to both cleco_game and websocket state slices and displays:
...
class CurrentRoomWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListenableBuilder(
      ...
      builder: (context, child) {
        // Get cleco game state for joined games
        ...
        final joinedGamesSlice = clecoGameState['joinedGamesSlice'] as Map<String, dynamic>? ?? {};
  ...
  void _enterGameRoom(BuildContext context, Map<String, dynamic> gameData) async {
    try {
      // Clean up cleco game state before joining real game            
      ...
      // Update cleco game state with current game data using validated state updater
