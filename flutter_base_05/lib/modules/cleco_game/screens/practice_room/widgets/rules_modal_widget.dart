...
/// Rules Modal Widget for Cleco Room
/// 
/// This widget displays the game rules and overview as a modal overlay.
/// It's shown when the "View Rules" button is pressed in the cleco room.
...
5. **Call Cleco**: When you think you can win, call "Cleco"
...
• **After Cleco**: Lowest points wins
• **Tie Breaker**: Fewer cards wins
• **Cleco Caller**: Wins ties if involved
...
• Call "Cleco" when you're confident
