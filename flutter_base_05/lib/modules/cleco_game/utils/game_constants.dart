/// Game constants for the Cleco card game
class GameConstants {
  // Game settings
  ...
  static const String PHASE_RECALL = 'cleco';
  ...
  // WebSocket events
  static const String WS_EVENT_GAME_JOINED = 'cleco_game_joined';
  static const String WS_EVENT_GAME_LEFT = 'cleco_game_left';
  static const String WS_EVENT_PLAYER_JOINED = 'cleco_player_joined';
  static const String WS_EVENT_PLAYER_LEFT = 'cleco_player_left';
  static const String WS_EVENT_GAME_STARTED = 'cleco_game_started';
  static const String WS_EVENT_GAME_ENDED = 'cleco_game_ended';
  static const String WS_EVENT_TURN_CHANGED = 'cleco_turn_changed';
  static const String WS_EVENT_CARD_PLAYED = 'cleco_card_played';
  static const String WS_EVENT_RECALL_CALLED = 'cleco_cleco_called';
  static const String WS_EVENT_GAME_STATE_UPDATED = 'cleco_game_state_updated';
  static const String WS_EVENT_ERROR = 'cleco_error';
  
  // Player actions
  static const String ACTION_JOIN_GAME = 'cleco_join_game';
  static const String ACTION_LEAVE_GAME = 'cleco_leave_game';
  static const String ACTION_PLAY_CARD = 'cleco_player_action';
  static const String ACTION_CALL_RECALL = 'cleco_player_action';
  static const String ACTION_USE_SPECIAL_POWER = 'cleco_player_action';
  ...
  static const String MSG_RECALL_CALLED = 'Cleco called!';
  static const String MSG_SPECIAL_POWER_USED = 'Special power used';
  static const String MSG_NOT_YOUR_TURN = 'Not your turn';
  static const String MSG_CANNOT_CALL_RECALL = 'Cannot call cleco at this time';
