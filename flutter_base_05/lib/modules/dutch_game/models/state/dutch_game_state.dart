...
/// Main immutable state for the entire Dutch Game module
/// This is the Single Source of Truth (SSOT) for all dutch game state
@immutable
class DutchGameState extends ImmutableState with EquatableMixin {
  // Connection state
  ...
  factory DutchGameState.initial() {
  ...
  factory DutchGameState.fromJson(Map<String, dynamic> json) {
  ...
  @override
  String toString() => 'DutchGameState(game=$currentGameId, ${games.games.length} games)';
}
