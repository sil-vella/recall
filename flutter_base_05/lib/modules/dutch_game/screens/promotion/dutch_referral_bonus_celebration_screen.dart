...
/// Full-screen celebration after a successful campaign referral coin award.
/// Visual language matches [CoinPurchaseCelebrationScreen] and [DutchWinCelebrationScreen].
class DutchReferralBonusCelebrationScreen extends StatefulWidget {
  const DutchReferralBonusCelebrationScreen({
    super.key,
  ...
  @override
  State<DutchReferralBonusCelebrationScreen> createState() =>
      _DutchReferralBonusCelebrationScreenState();
}

class _DutchReferralBonusCelebrationScreenState
    extends State<DutchReferralBonusCelebrationScreen>
  ...
  String get _successMessage =>
      'You earned ${widget.coinsAwarded} bonus coins!';
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      identifier: 'referral_bonus_celebration_screen',
      label: 'Bonus coins awarded: $_successMessage',
      child: Scaffold(
        ...
        body: Stack(
          ...
          children: [
            ...
            SafeArea(
              child: Padding(
                padding: AppPadding.screenPadding.copyWith(top: 0),
                      ...
                      FadeTransition(
                        ...
                        child: Center(
                          child: DutchAnimatedCtaButton(
                            ...
                            expand: false,
                            semanticIdentifier: 'referral_bonus_celebration_continue',
                          ),
                        ),
                      ),
                    ],
