...
class StateQueueValidator {
  ...
  static const bool LOGGING_SWITCH = false; // lastCoinPurchaseJoinContext / coin-purchase flow (enable-logging-switch.mdc)
  ...
  static const Map<String, DutchStateFieldSpec> _stateSchema = {
    ...
    // Removed protectedCardsToPeekTimestamp - widget uses internal timer instead
