...
class GameStateData extends ImmutableState with EquatableMixin {
  ...
  GameStateData copyWith({
    ...
    return GameStateData(
      ...
      recallCalledBy: recallCalledBy ?? this.recallCalledBy,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'phase': phase,
      if (recallCalledBy != null) 'recallCalledBy': recallCalledBy,
  ...
  factory GameStateData.fromJson(Map<String, dynamic> json) {
    ...
    return GameStateData(
      ...
      recallCalledBy: json['recallCalledBy'] as String?,
  ...
  List<Object?> get props => [
    ...
    recallCalledBy, lastPlayedCard, winners
  ];
