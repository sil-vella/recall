...
class _JoinRoomWidgetState extends State<JoinRoomWidget> {
  ...
  Future<void> _findRoom() async {
    ...
    if (roomId.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Please enter a room ID to find'),
  ...
  Future<void> _joinRoom() async {
    ...
    try {
      ...
      if (_isPrivateRoom && password.isEmpty) {
        throw Exception('Password is required for private rooms');
      }
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Join room request sent successfully'),
            backgroundColor: Colors.green,
          ),
        );
      }
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  ...
                  Expanded(
                    child: ElevatedButton.icon(
                      ...
                      label: Text(_isFinding ? 'Finding...' : 'Find Room'),
              ...
              Text(
                _isPrivateRoom
                    ? 'This is a private room. Password required.'
                    : 'This is a public room. No password needed.',
