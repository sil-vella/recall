...
class WebSocketManager {
  ...
  Future<bool> initialize() async {
    ...
    try {
      ...
      // Get JWT token from auth manager for authentication
      final hasToken = await _authManager.hasValidToken();
      if (!hasToken) {
      ...
      // Get the JWT token
      final authToken = await _authManager.getCurrentValidToken();
      if (authToken == null) {
