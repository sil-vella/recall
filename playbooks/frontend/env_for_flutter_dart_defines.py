...
Ad unit IDs are NOT dart-defines — SSOT: .env.local / .env.prod → Flask init-config.
Native application id: ADMOB_APPLICATION_ID in dart-defines (Android) and GAD_APPLICATION_ID
in ios/Flutter/*.xcconfig (iOS); always production Dutch app id.
"""
