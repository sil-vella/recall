...
Reads the default card back image from app_media/media/card_back.webp (relative to project root)
and uploads it to the VPS at /var/www/dutch.reignofplay.com/app_media/media/card_back.webp (served at https://dutch.reignofplay.com/...).
...
REMOTE_IMAGE_PATH = f'{REMOTE_IMAGE_DIR}/card_back.webp'
REMOTE_TMP_IMAGE = '/tmp/card_back.webp'
LOCAL_IMAGE_PATH = PROJECT_ROOT / 'app_media' / 'media' / 'card_back.webp'
...
def upload_image(local_image_path: Path):
    ...
    print(f"Expected URL: {Colors.BLUE}https://dutch.reignofplay.com/app_media/media/card_back.webp{Colors.NC}")
    print()
...
def main():
    ...
    # Image is always taken from app_media/media/card_back.webp
