...
Usage:
  python playbooks/rop01/generate_consumable_placeholder_webps.py
  python playbooks/rop01/generate_consumable_placeholder_webps.py --force

Local dev copy: playbooks/00_local/templates/consumables/generate_consumable_placeholder_webps.py
"""
