# Dutch Game Data Conversion Structure
...
def _to_flutter_player_data(self, player, is_current: bool = False) -> Dict[str, Any]:
    ...
    return {
        ...
        'hasCalledDutch': bool(player.has_called_dutch),
    }
```
...
def _to_flutter_game_data(self, game: GameState) -> Dict[str, Any]:
    ...
    game_data = {
        ...
        'gameId': game.game_id,
        'gameName': f"Dutch Game {game.game_id}",
        ...
        'status': 'active' if game.phase.value in ['player_turn', 'out_of_turn_play', 'dutch_called'] else 'inactive',
        ...
        'dutchCalledBy': game.dutch_called_by,
