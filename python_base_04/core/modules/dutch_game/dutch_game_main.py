...
class DutchGameMain(BaseModule):
    ...
    def register_routes(self):
        ...
        try:
            ...
            self._register_route_helper("/userauth/dutch/invite-response", api_endpoints.invite_response, methods=["POST"], auth="jwt")
            self._register_route_helper("/userauth/dutch/notify-room-ready", api_endpoints.notify_room_ready, methods=["POST"], auth="jwt")
            self._register_route_helper("/userauth/dutch/room-join-ack", api_endpoints.room_join_ack, methods=["POST"], auth="jwt")
