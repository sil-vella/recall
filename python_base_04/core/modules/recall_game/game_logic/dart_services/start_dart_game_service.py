#!/usr/bin/env python3
"""
Startup script for Dart Game Service Integration

This script initializes the Dart game service and provides a simple test interface.
"""
...
from core.modules.recall_game.dart_subprocess_manager import dart_subprocess_manager
