...
class Config:
    ...
    # Recall Game Configuration
    RECALL_PLAYER_ACTION_TIMEOUT = int(get_file_first_config_value("recall_player_action_timeout", "RECALL_PLAYER_ACTION_TIMEOUT", "10"))  # Player action timeout in seconds
