...
class GameRoomState:
    ...
    def serialize(self, full=True):
        ...
        return {
            'game_id': self.game_id,  # Include game_id in serialization
            'game_mode': self.game_mode,
            'players': {player_id: player.serialize() for player_id, player in self.players.items()},
            'current_player': self.current_player,
            'special_cards_queue': self.special_cards_queue,
            'face_down_cards': self.face_down_cards,
            'face_up_cards': self.face_up_cards,
            'winners_queue': self.winners_queue,
            'called_user_id': self.called_user_id,
            'game_play_state': self.state.name
        }